...
import { getAllExchangeCategory } from '../../redux/action/ExchangeCategoryAction.js';

const HomeCategory = () => {

    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(getAllExchangeCategory());
    }, [])

    const categories = useSelector(state => state.allExCategory.Excategory)
